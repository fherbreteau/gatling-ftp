...
import com.github.fherbreteau.gatling.ftp.client.FtpActions.{Action, Copy, Delete, Download, Move, Upload}
import com.github.fherbreteau.gatling.ftp.client.result.{FtpFailure, FtpResponse, FtpResult}
