...
import com.github.fherbreteau.gatling.ftp.client.FtpActions.{Action => FtpClientAction}
import com.github.fherbreteau.gatling.ftp.client.{FtpOperationBuilder, FtpOperationDef}
import com.github.fherbreteau.gatling.ftp.protocol.{FtpComponents, FtpProtocol}
