package com.github.fherbreteau.gatling.ftp.examples

import com.github.fherbreteau.gatling.ftp.Predef.ftp
import com.github.fherbreteau.gatling.ftp.protocol.FtpProtocolBuilder
...
object SftpSimulation {
  def main(args: Array[String]): Unit =
    Gatling.fromMap((new GatlingPropertiesBuilder)
      .simulationClass(classOf[com.github.fherbreteau.gatling.ftp.examples.FtpSimulation].getName).build)
}
